    ...
    <footer className="footer-main">
      <div className="footer-container">
        ...
        <div className="footer-section animate-up">
          <h3 className="cinzel-font">EVENTLY<span>$</span></h3>
          <p className="footer-description">
            Engineering seamless connections through sophisticated event management.
             <span >EVENTLY<span className="superscript">$</span></span> provides the tools to curate, manage, and scale meaningful experiences for organizers and attendees alike.
          </p>
        </div>
        ...
        <div className="footer-section animate-up" style={{ animationDelay: '0.1s' }}>
          ...
          <ul className="footer-links">
            <li><a href="/EventsPage">Discover</a></li>
            <li><a href="/Dashboard">My Schedule</a></li>
